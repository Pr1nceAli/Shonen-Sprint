class Goku extends Entity {
	constructor(game) {
		...
		this.idle_animator = new Animator(assetManager.getAsset("./Assets/goku_sprites.png"),
		620, 120, 42, 60, 2, 0.45)

		this.run_animator = new Animator(assetManager.getAsset("./Assets/goku_sprites.png"),
		236, 272, 46, 60, 4, 0.15)

		this.jump_animator = new Animator(assetManager.getAsset("./Assets/goku_jump.png"),
